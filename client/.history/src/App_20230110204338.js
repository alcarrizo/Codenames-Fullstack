...
const App = () => {
  ...
  const assignCards = (size, usedArr, arr) => {
  ...
  const setUpCards = () => {
    ...
    // }
    assignCards(25, usedWords, cardWords)
    ...
    let randomNum = Math.round(Math.random() * 24)
    usedWords.push(randomNum)
    blackCard.push(randomNum)

    // getting blue cards
    // for (let i = 0; i < 9; i++) {
    //   let randumNum = Math.round(Math.random() * 24)

    //   while (usedWords.includes(randumNum)) {
    //     randumNum = Math.round(Math.random() * 24)
    //   }

    //   usedWords.push(randumNum)
    //   blueCards.push(randumNum)

    // }
    assignCards(9, usedWords, blueCards)
    ...
    //   usedWords.push(randumNum)
    //   redCards.push(randumNum)

    // }
    assignCards(8, usedWords, redCards)
    ...
    const newCards = cards.map((c, i) => {
      ...
      return { ...c, word: cardWords[i], team: team }
    })
