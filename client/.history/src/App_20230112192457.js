...
const PlayerInfo = ({ joinClass, className, joinTeam, numCards }) => {
  return (
    <div className={className + "Team"}>
      ...
      <p id={className + '-remaining-cards'}>{numCards}</p>
    </div>
  )
...
const App = () => {
  ...
  console.log(cards.filter(c => c.picked === false && c.team === 'blue').length)
    ...
    <div className="App">
      ...
      <div className='wrapper'>
        <div className={"redSide"}>
          <PlayerInfo numCards={cards.filter(c => c.team === 'red' && !c.picked).length} joinClass={joinClass} joinTeam={joinTeam} className={'red'} />
          <div className='menu'>
        ...
        <div className={"blueSide"}>
          <PlayerInfo numCards={cards.filter(c => c.team === 'blue' && !c.picked).length} joinClass={joinClass} joinTeam={joinTeam} className={'blue'} />
