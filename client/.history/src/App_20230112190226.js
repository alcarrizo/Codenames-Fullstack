...
const PlayerInfo = ({ joinClass, className, joinTeam }) => {
  return (
...
const App = () => {
  ...
  document.getElementById('blue-remaining-cards').innerHTML = cards.filter(c => c.team === 'blue').length
  const revealCard = (id) => {
    ...
    <div className="App">
      ...
      <div className='wrapper'>
        <div className={"redSide"}>
          <PlayerInfo joinClass={joinClass} joinTeam={joinTeam} className={'red'} />
          <div className='menu'>
        ...
        <div className={"blueSide"}>
          <PlayerInfo joinClass={joinClass} joinTeam={joinTeam} className={'blue'} />
