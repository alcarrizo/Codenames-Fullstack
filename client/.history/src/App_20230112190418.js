    ...
    <div className="App">
      ...
      <div className='wrapper'>
        <div className={"redSide"}>
          <PlayerInfo numCards={cards.filter(c => c.team === 'red')} joinClass={joinClass} joinTeam={joinTeam} className={'red'} />
          <div className='menu'>
        ...
        <div className={"blueSide"}>
          <PlayerInfo numCards={cards.filter(c => c.team === 'blue')} joinClass={joinClass} joinTeam={joinTeam} className={'blue'} />
