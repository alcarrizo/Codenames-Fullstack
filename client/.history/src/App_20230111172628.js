...
const App = () => {
  ...
  const restart = () => {
    ...
    document.getElementById("blue-operative-players").innerHTML += player.name + " "
    document.getElementById("blue-spymaster-players").innerHTML += player.name + " "
    document.getElementById("red-operative-players").innerHTML += player.name + " "
    document.getElementById("red-spymaster-players").innerHTML += player.name + " "
    ...
    <div className="App">
      ...
      <div className='wrapper'>
        <div className={"redSide"}>
          ...
          <div className='menu'>
            <Btn className='menuBtn' onClick={() => setUpCards()} id="startBtn" name="Start Game" />
            <Btn className='menuBtn' onClick={() => restart()} id="resetBtn" name="Reset Teams" />
          </div>
        </div>
        ...
        <div className={"blueSide"}>
          ...
          <Btn onClick={() => changeTurn()} className='menuBtn' id="endTurn" name="End Turn" />
        </div>
